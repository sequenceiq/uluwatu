                     ...
                     <div class="col-md-6">
                        ...
                        <div class="col-md-6 col-sm-12">
                           ...
                           <div ng-repeat="instanceGroup in cluster.instanceGroups | orderBy : 'group' : false">
                              ...
                              <a target="_blank">{{instanceGroup.metadata[0].publicIp}} <span style="padding-left: 10px;" role="button" data-toggle="modal" data-target="#modal-start-cluster" ng-click="selectMetadata(instanceGroup.metadata[0], cluster.cluster.userName)" class="glyphicon glyphicon-link" aria-hidden="true" ng-show="instanceGroup.metadata && instanceGroup.metadata.length != 0 && instanceGroup.metadata[0].publicIp!=null"></span></a><br/>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
