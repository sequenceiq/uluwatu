...
<div class="col-md-12 green-border">
    <div class="col-md-4"><span class="blue">Blueprint Name</span> : {{blueprint.ambariBlueprint.Blueprints.blueprint_name}}</div>
    <div class="col-md-4"><span class="blue">Stack Name</span> : {{blueprint.ambariBlueprint.Blueprints.stack_name}}</div>
    <div class="col-md-4"><span class="blue">Stack Version</span> : {{blueprint.ambariBlueprint.Blueprints.stack_version}}</div>
</div>
